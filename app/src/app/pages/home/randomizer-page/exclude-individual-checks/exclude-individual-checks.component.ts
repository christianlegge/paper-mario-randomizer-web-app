...
@Component({
  selector: 'app-exclude-individual-checks',
  templateUrl: './exclude-individual-checks.component.html',
  styleUrls: ['./exclude-individual-checks.component.scss']
})
export class ExcludeIndividualChecksComponent implements OnInit {
